...
Generates 512x512 keyframe images from text prompts.

VRAM Budget: ~6GB (NF4 quantized with CPU offload)
Output: 512x512 RGB images

This model is part of the Narrative Chain pipeline (Phase 4) and:
...
- Returns image tensors for downstream CogVideoX processing
...
class FluxModel:
    ...
    Generates 512x512 keyframe images from text prompts using the Flux-Schnell
