...
impl SubstrateCli for Cli {
    ...
    fn description() -> String {
        format!(
			"NSN Node - Neural Sovereign Network\n\nThe command-line arguments provided first will be \
		passed to the NSN node, while the arguments provided after -- will be passed \
		to the relay chain node (for parachain mode).\n\n\
		{} <nsn-args> -- <relay-chain-args>",
    ...
    fn support_url() -> String {
        "https://github.com/neural-sovereign-network/nsn-chain/issues/new".into()
    }
