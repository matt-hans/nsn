...
// NSN Chain Token Constants
// 1 NSN = 10^18 base units (18 decimals, matching Ethereum/DOT convention)
...
pub const UNIT: Balance = NSN;
pub const MILLI_UNIT: Balance = MILLI_NSN;
pub const MICRO_UNIT: Balance = MICRO_NSN;

/// The existential deposit. Set to 0.001 NSN (minimum balance to keep account alive)
pub const EXISTENTIAL_DEPOSIT: Balance = MILLI_NSN;
