...
use frame_support::{
    construct_runtime, parameter_types, traits::ConstU32, traits::Everything, PalletId,
};
use sp_core::H256;
use sp_runtime::{traits::BlakeTwo256, traits::IdentityLookup, BuildStorage};
...
construct_runtime!(
    pub enum Test
    {
        ...
        Stake: pallet_nsn_stake::{Pallet, Call, Storage, Event<T>, FreezeReason},
        Reputation: pallet_nsn_reputation::{Pallet, Call, Storage, Event<T>},
        Pinning: pallet_nsn_storage::{Pallet, Call, Storage, Event<T>, HoldReason},
    }
);
