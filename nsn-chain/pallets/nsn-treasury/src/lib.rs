...
//! - `record_director_work`: Track director slot completion (internal, called by pallet-nsn-director)
//! - `record_validator_work`: Track validator votes (internal, called by pallet-nsn-bft)
//!
//! ### Hooks
//!
...
pub mod pallet {
    ...
    pub type AccumulatedContributionsMap<T: Config> =
        StorageMap<_, Blake2_128Concat, T::AccountId, AccumulatedContributions, ValueQuery>;
    ...
    impl<T: Config> Pallet<T> {
        ...
        ///
        /// Internal function called by pallet-nsn-director when a director completes a slot.
        ///
        /// # Parameters
        /// - `origin`: Root or pallet-nsn-director
        ...
        ///
        /// Internal function called by pallet-nsn-bft when a validator submits correct votes.
        ///
        /// # Parameters
        /// - `origin`: Root or pallet-nsn-bft
    ...
    impl<T: Config> Pallet<T> {
        ...
        fn distribute_rewards(block: BlockNumberFor<T>) -> DispatchResult {
            ...
            // pinner_pool reserved for pallet-nsn-pinning integration
        ...
        pub fn distribute_validator_rewards(pool: BalanceOf<T>) -> DispatchResult {
            ...
            for (account, contrib) in contributions {
                ...
                let reward = pool.saturating_mul(votes_balance) / total_votes_balance;
